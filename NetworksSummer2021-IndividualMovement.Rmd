...
Comparing the fitted model with a model of known slope (=0.5) shows that the outgoing ants do have a slight right bias, with a 53.7% chance of turning right. Here is a plot to illustrate it:
...
Comparing the fitted model with a model of known slope (=0.5) shows that outgoing ants have a significant wide bias, staying on the wide branch 57.9% of the time where width could be considered. This plot illustrates this:
