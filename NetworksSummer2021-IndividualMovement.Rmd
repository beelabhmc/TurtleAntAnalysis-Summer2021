...
Finally I left_join the turn choices by Node.From and Node.To to get a column for angle of turn.

```{r}
turn_choices_angle <- turn_choices %>%
  left_join(turns, by=c("Node.From", "Node.To"))
```